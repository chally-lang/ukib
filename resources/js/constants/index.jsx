...
import imaged1 from "@/images/detail-1.png"
import imaged2 from "@/images/detail-2.png";
import imaged3 from "@/images/detail-3.png";
import imaged4 from "@/images/detail-4.png";
...
var link1 = route('login');
var link3 = route('page-read');
var link4 = route('page-read2');
...
export const features = [
  {
    ...
    icon: features1,
    href: link1,
    caption: "Smart Automation & Easy integration",
    title: "Study Smarter",
    text: "Our Library is designed to better your learning experiences irrespective of your location and time frame or even in a hybrid learning environment.",
    button: {
      icon: magictouch,
      title: "Study Now",
    },
  },
  {
    id: "1",
    icon: features2,
    caption: "Secure & Trusted",
    href: route('dashboard'),
    title: "Your data is Secured, we got your back",
    text: "Your data security is our priority. With state-of-the-art encryption and robust privacy controls, your information is secure.",
    button: {
      icon: docs,
...
export const details = [
  ...
  },
  {
    id: "1",
    icon: imaged2,
    title: "Inbuilt Note Taking Functionality",
  },
  {
    id: "2",
    icon: imaged3,
...
export const faq = [
  {
    ...
    answer:[
      {
        id:"0",
        book:"Philosophy of man",
        href:link3,
      },
      {
        id:"1",
        book:"never back over",
        href:link4
      },
      {
        id:"2",
        book:"jongo brilliance",
        href:link3,
      },
      {
        id:"3",
...
export const NOTE_PRIORITY_CLASS_MAP = {
  'Todo' : 'bg-gray-600',
  'Doing' : 'bg-amber-600',
  'Done' : 'bg-green-900',
} 

export const NOTE_PRIORITY_TEXT_MAP = {
  'Todo' : 'Todo',
  'Doing' : 'In Progress',
  'Done' : 'Completed'
} 

export const NOTE_STATUS_CLASS_MAP = {
  'pending' : 'bg-amber-500',
  'in_progress' : 'bg-blue-500',
  'completed' : 'bg-green-500',
} 

export const NOTE_STATUS_TEXT_MAP = {
  'pending' : 'Pending',
...
export const BLOG_PRIORITY_TEXT_MAP = {
  'low' : 'Low',
  'medium' : 'Medium',
  'high' : 'High',
} 

export const BLOG_PRIORITY_CLASS_MAP = {
  'low' : 'bg-gray-600',
  'medium' : 'bg-amber-600',
  'high' : 'bg-red-600',
} 

export const BOOKUSER_STATUS_CLASS_MAP = {
  'activated' : 'bg-green-500',
  'de_activated' : 'bg-red-600',
} 

export const BOOKUSER_STATUS_TEXT_MAP = {
  'activated' : 'Activated',
...
export const USER_CAT_CLASS_MAP = {
  'subscribed' : 'bg-green-500',
  'un_subscribed' : 'bg-red-600'
} 

export const USER_CAT_TEXT_MAP = {
